...
export function SignalNudgeBanner({
  ...
  return (
    <div className="fixed bottom-[calc(max(1rem,env(safe-area-inset-bottom))+4.5rem+var(--participant-tabbar,0px))] left-0 right-0 z-[45] flex justify-center px-3 min-[360px]:px-4 pointer-events-none">
