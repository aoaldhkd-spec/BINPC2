...
const MINI_GAMES = [
  { name: '369 게임', emoji: '3️⃣', desc: '순서대로 1부터 숫자를 말하되 3, 6, 9가 포함된 숫자에서는 박수를 칩니다.', tip: '33은 박수 두 번! 숫자를 빠르게 이어가면 실수가 나옵니다.' },
  { name: '베스킨라빈스 31', emoji: '🍦', desc: '1~3개 숫자를 차례로 말하며 31을 말하는 사람이 집니다.', tip: '31의 배수 주변 숫자가 핵심! 22, 25, 28 구간이 승부처입니다.' },
  { name: '눈치게임', emoji: '👀', desc: '아무 순서 없이 1부터 인원 수까지 각자 하나씩 외칩니다. 동시에 외치면 OUT!', tip: '서로 눈치를 보다 마지막 번호를 외치는 사람이 지는 경우도 있습니다.' },
  { name: '폭탄 돌리기', emoji: '💣', desc: '음악이 멈추면 폭탄(물건)을 들고 있는 사람이 집니다.', tip: '음악 속도나 길이를 랜덤하게 하면 더 재밌습니다.' },
];
