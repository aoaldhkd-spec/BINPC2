...
const CORE_TAG_GROUPS = [
  { label: '얼굴상 👀', tags: ['감자상', '댕댕이상', '고양이상', '여우상', '공룡상', '양아치상', '웃상', '이목구비또렷'] },
  { label: '체형 💪', tags: ['키큰', '슬림', '근육있는', '통통귀여운', '보통체형'] },
  { label: '매력 ✨', tags: ['섹끼있는', '귀여운', '반전매력', '눈웃음', '웃을때예쁜', '보조개', '쇄골이쁜', '🍑이쁨', '남자다운', '스타일좋은'] },
  { label: '특기 ⭐', tags: ['노래잘함', '운동잘함', '요리잘함'] },
...
export const IDEAL_TAG_SPECS: readonly IdealTagSpec[] = [
  ...
  ...specsFor('매력 ✨', 'status_msg+bio', ['섹끼있는', '귀여운', '반전매력', '눈웃음', '웃을때예쁜', '보조개', '쇄골이쁜', '🍑이쁨', '남자다운', '스타일좋은'], {
    눈웃음: ['눈웃음', '눈웃는', '눈웃음예쁜'],
    보조개: ['보조개', '보조개있는', '보조개예쁜'],
    쇄골이쁜: ['쇄골이쁜', '쇄골 예쁜', '쇄골'],
  ...
  ...specsFor('특기 ⭐', 'interests+status_msg+bio', ['노래잘함', '운동잘함', '요리잘함'], {
  ...
  ...specsFor('매력 ✨', 'status_msg+bio', ['웃음많은', '분위기있는', '눈매예쁜', '미소가예쁜', '🍆이쁨']),
