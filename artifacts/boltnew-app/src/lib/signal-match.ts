...
const CORE_TAG_GROUPS = [
  ...
  { label: '재능 ⭐', tags: ['노래잘함 🎤', '운동잘함 🏋️', '요리잘함 🍳', '밤일 잘함 🌙', '키스잘함 💋', '달아오르게 잘함 🔥', '🍌 바나나 잘먹음', '🥛 우유 잘먹음'] },
  { label: '라이프 🏠', tags: ['자가있음 🏡', '숙소있음 🛏️', '자차있음 🚗', '돈잘범 💰'] },
  { label: '성격 💫', tags: ['다정한 💕', '시크한 😎', '장난끼있는 😜', '차분한 🧘', '유머있는 😂', '솔직한 💬', '리드하는 👑', '챙겨주는 🤗', '배려심많은 💝', '긍정적인 ☀️', '활발한 ⚡', '수줍은 🙈'] },
] as const;
...
export const IDEAL_TAG_SPECS: readonly IdealTagSpec[] = [
  ...
  ...specsFor('매력 ✨', 'status_msg+bio', IDEAL_TAG_GROUPS[2].tags, {
    ...
    '귀여운 🥰': ['귀여운 🥰', '귀여운'],
    '반전매력 🎭': ['반전매력 🎭', '반전매력', '반전'],
    '눈웃음 😊': ['눈웃음 😊', '눈웃음', '눈웃는', '눈웃음예쁜'],
    '웃을때예쁜 😁': ['웃을때예쁜 😁', '웃을때예쁜', '웃을때 예쁜', '웃을때이쁜'],
    '보조개 ✨': ['보조개 ✨', '보조개', '보조개있는', '보조개예쁜'],
    '쇄골이쁜 💎': ['쇄골이쁜 💎', '쇄골이쁜', '쇄골 예쁜', '쇄골'],
    '🍑이쁨': ['🍑이쁨', '엉덩이', '엉덩이이쁨', '엉덩이 예쁨'],
    '🍑좁음': ['🍑좁음', '복숭아좁음', '복숭아 좁음'],
    '🍆이쁨': ['🍆이쁨', '엉덩이', '엉덩이이쁨', '엉덩이 예쁨'],
    '🍆큼': ['🍆큼', '가지큼', '가지 큼'],
    '스타일좋은 👔': ['스타일좋은 👔', '스타일좋은', '스타일 좋은', '패션'],
    '테토 🎸': ['테토 🎸', '테토', 'Teto'],
    '에겐 🌸': ['에겐 🌸', '에겐', 'Egen', 'ENFP vibe'],
  }),
  ...specsFor('재능 ⭐', 'interests+status_msg+bio', ['노래잘함 🎤', '운동잘함 🏋️', '요리잘함 🍳'], {
    '노래잘함 🎤': ['노래잘함 🎤', '노래잘함', '노래 잘함', '노래잘하는', ...SING_INTERESTS],
    '운동잘함 🏋️': ['운동잘함 🏋️', '운동잘함', '운동 잘함', '운동잘하는', ...MUSCLE_INTERESTS],
    '요리잘함 🍳': ['요리잘함 🍳', '요리잘함', '요리 잘함', '요리잘하는', ...COOK_INTERESTS],
  }),
  ...specsFor('재능 ⭐', 'status_msg+bio', ['밤일 잘함 🌙', '키스잘함 💋', '달아오르게 잘함 🔥', '🍌 바나나 잘먹음', '🥛 우유 잘먹음'], {
    '밤일 잘함 🌙': ['밤일 잘함 🌙', '밤일 잘함', '밤일잘함', '밤일'],
    '키스잘함 💋': ['키스잘함 💋', '키스잘함', '키스 잘함', '키스잘하는'],
    '달아오르게 잘함 🔥': ['달아오르게 잘함 🔥', '달아오르게 잘함', '달아오르게잘함', '달아오르게'],
    '🍌 바나나 잘먹음': ['🍌 바나나 잘먹음', '🍌바나나 잘먹음', '바나나 잘먹음', '바나나잘먹음', '바나나'],
    '🥛 우유 잘먹음': ['🥛 우유 잘먹음', '🥛우유 잘먹음', '우유 잘먹음', '우유잘먹음', '우유'],
  }),
  // 레거시 저장 태그(이모지 없는 재능·매력·체형·성격·라이프)
  ...
  ...specsFor('재능 ⭐', 'status_msg+bio', ['밤일 잘함', '키스잘함', '달아오르게 잘함'], {
    '밤일 잘함': ['밤일 잘함', '밤일잘함', '밤일'],
  ...
  ...specsFor('라이프 🏠', 'status_msg+bio', IDEAL_TAG_GROUPS[4].tags, {
    '자가있음 🏡': ['자가있음 🏡', '자가있음', '자가', '내집', '집있음'],
    '숙소있음 🛏️': ['숙소있음 🛏️', '숙소있음', '숙소', '방있음'],
    '자차있음 🚗': ['자차있음 🚗', '자차있음', '자차', '차있음', '차량있음'],
    '돈잘범 💰': ['돈잘범 💰', '돈잘범', '돈 잘범', '수입좋음', '잘벎'],
  }),
  ...specsFor('라이프 🏠', 'status_msg+bio', ['자가있음', '숙소있음', '자차있음', '돈잘범']),
  ...specsFor('성격 💫', 'status_msg+bio', IDEAL_TAG_GROUPS[5].tags, {
    '다정한 💕': ['다정한 💕', '다정한'],
    '시크한 😎': ['시크한 😎', '시크한'],
    '장난끼있는 😜': ['장난끼있는 😜', '장난끼있는', '장난기'],
    '차분한 🧘': ['차분한 🧘', '차분한'],
    '유머있는 😂': ['유머있는 😂', '유머있는', '유머'],
    '솔직한 💬': ['솔직한 💬', '솔직한'],
    '리드하는 👑': ['리드하는 👑', '리드하는', '리드'],
    '챙겨주는 🤗': ['챙겨주는 🤗', '챙겨주는'],
    '배려심많은 💝': ['배려심많은 💝', '배려심많은', '배려'],
    '긍정적인 ☀️': ['긍정적인 ☀️', '긍정적인', '긍정'],
    '활발한 ⚡': ['활발한 ⚡', '활발한'],
    '수줍은 🙈': ['수줍은 🙈', '수줍은', '수줍'],
  }),
  ...specsFor('성격 💫', 'status_msg+bio', ['다정한', '시크한', '장난끼있는', '차분한', '유머있는', '솔직한', '리드하는', '챙겨주는', '배려심많은', '긍정적인', '활발한', '수줍은']),
  // 레거시 저장 태그(이모지 없는 매력)
  ...specsFor('매력 ✨', 'status_msg+bio', ['섹끼있는', '귀여운', '반전매력', '눈웃음', '웃을때예쁜', '보조개', '쇄골이쁜', '스타일좋은', '테토', '에겐']),
