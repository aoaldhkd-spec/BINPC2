...
describe('client event schedule quotas', () => {
  it('updates all heart types at an opened clock slot without changing JSON', () => {
    ...
    expect(eventHeartQuotas(schedule, new Date('2026-09-16T14:04:59.000Z'))).toEqual({ red: 2, blue: 2, pink: 2, green: 2 });
    expect(eventHeartQuotas(schedule, new Date('2026-09-16T14:05:00.000Z'))).toEqual({ red: 4, blue: 3, pink: 2, green: 5 });
  });
});
